...
const badgeVariants = tv({
  ...
  variants: {
    variant: {
      default: [
        "bg-gray-50 text-orange-700 ring-blue-500/30",
        "dark:bg-orange-50 dark:text-orange-700 dark:ring-orange-700/30",
      ],
      neutral: [
      ...
      glass: [
        "bg-black/80 shadow-2xl shadow-black/5 backdrop-blur-sm ring-gray-500/20 backdrop-blur-sm text-gray-200 py-2"
      ],
      slate: [
        "bg-gray-900 text-gray-200 ring-gray-500/30"
      ],
    },
  },
  defaultVariants: {
