  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 flex flex-col items-center gap-3 px-2 text-center sm:gap-4 sm:px-4">
        <HyperText className="text-xs md:text-sm text-white font-normal">{mapContent?.subheading ?? ""}</HyperText>
        <h2
        ...
        {mapContent?.description && (
          <p className="max-w-2xl text-balance text-sm text-gray-300 sm:text-sm md:text-base">
            {mapContent.description}
          </p>
        )}
      </div>
