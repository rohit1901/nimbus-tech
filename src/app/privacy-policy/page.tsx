...
export async function generateMetadata({
  ...
  const descriptions = {
    "en-US":
      "Privacy Policy for Nimbus Tech GmbH - Learn how we collect, use, and protect your personal data in accordance with GDPR.",
    "de-DE":
      "Datenschutzerklärung der Nimbus Tech GmbH - Erfahren Sie, wie wir Ihre personenbezogenen Daten gemäß DSGVO erfassen, verwenden und schützen.",
  }
